...
CREATE TABLE IF NOT EXISTS `bd`.`cita` (
  ...
  INDEX `fk_cita_paciente1_idx` (`paciente_id_paciente` ASC) ,
...
CREATE TABLE IF NOT EXISTS `bd`.`factura` (
  ...
  INDEX `fk_factura_paciente1_idx` (`paciente_id_paciente` ASC) ,
...
CREATE TABLE IF NOT EXISTS `bd`.`inventario` (
  ...
  PRIMARY KEY (`id_inventario`, `insumodehospitalizacion_id_insumoDeHospitalizacion`),
  INDEX `id_entrada` (`id_insumo` ASC) ,
  INDEX `fk_inventario_insumodehospitalizacion1_idx` (`insumodehospitalizacion_id_insumoDeHospitalizacion` ASC) ,
  CONSTRAINT `inventario_ibfk_1`
    FOREIGN KEY (`id_insumo`)
    REFERENCES `bd`.`insumo` (`id_insumo`),
  CONSTRAINT `fk_inventario_insumodehospitalizacion1`
    FOREIGN KEY (`insumodehospitalizacion_id_insumoDeHospitalizacion`)
    REFERENCES `bd`.`insumodehospitalizacion` (`id_insumoDeHospitalizacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 11
...
-- -----------------------------------------------------
-- Table `bd`.`serviciomedico_has_factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd`.`serviciomedico_has_factura` (
  `serviciomedico_id_servicioMedico` INT(11) NOT NULL,
  `factura_id_factura` INT(11) NOT NULL,
  `factura_paciente_id_paciente` INT(11) NOT NULL,
  PRIMARY KEY (`serviciomedico_id_servicioMedico`, `factura_id_factura`, `factura_paciente_id_paciente`),
  INDEX `fk_serviciomedico_has_factura_factura1_idx` (`factura_id_factura` ASC, `factura_paciente_id_paciente` ASC) ,
  INDEX `fk_serviciomedico_has_factura_serviciomedico1_idx` (`serviciomedico_id_servicioMedico` ASC) ,
  CONSTRAINT `fk_serviciomedico_has_factura_serviciomedico1`
    FOREIGN KEY (`serviciomedico_id_servicioMedico`)
    REFERENCES `bd`.`serviciomedico` (`id_servicioMedico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_serviciomedico_has_factura_factura1`
    FOREIGN KEY (`factura_id_factura` , `factura_paciente_id_paciente`)
    REFERENCES `bd`.`factura` (`id_factura` , `paciente_id_paciente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `bd`.`personal_has_serviciomedico`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd`.`personal_has_serviciomedico` (
  `personal_id_personal` INT(11) NOT NULL,
  `serviciomedico_id_servicioMedico` INT(11) NOT NULL,
  PRIMARY KEY (`personal_id_personal`, `serviciomedico_id_servicioMedico`),
  INDEX `fk_personal_has_serviciomedico_serviciomedico1_idx` (`serviciomedico_id_servicioMedico` ASC) ,
  INDEX `fk_personal_has_serviciomedico_personal1_idx` (`personal_id_personal` ASC) ,
  CONSTRAINT `fk_personal_has_serviciomedico_personal1`
    FOREIGN KEY (`personal_id_personal`)
    REFERENCES `bd`.`personal` (`id_personal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_personal_has_serviciomedico_serviciomedico1`
    FOREIGN KEY (`serviciomedico_id_servicioMedico`)
    REFERENCES `bd`.`serviciomedico` (`id_servicioMedico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `bd`.`factura_has_inventario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd`.`factura_has_inventario` (
  `factura_id_factura` INT(11) NOT NULL,
  `inventario_id_inventario` INT(11) NOT NULL,
  PRIMARY KEY (`factura_id_factura`, `inventario_id_inventario`),
  INDEX `fk_factura_has_inventario_inventario1_idx` (`inventario_id_inventario` ASC) ,
  INDEX `fk_factura_has_inventario_factura1_idx` (`factura_id_factura` ASC) ,
  ...
  CONSTRAINT `fk_factura_has_inventario_inventario1`
    ...
    REFERENCES `bd`.`inventario` (`id_inventario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
