...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= $urlBase ?>../src/assets/cssVista/ayudaInteractiva.css">
...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<a class="nav-link collapsed d-flex desplegableAyuda" href="#" data-bs-toggle="collapse" data-bs-target="#collapseUsuario" aria-expanded="false" aria-controls="collapseUsuario">
		...
		<div class="collapse " id="collapseUsuario" aria-labelledby="headingCitas" data-bs-parent="#sidenavAccordion d-flex">
			<nav class="sb-sidenav-menu-nested nav">
				...
				<a href="#" class="mx-5" data-bs-toggle="modal" data-bs-target="#cerrar">
					<svg width="16" xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 96 96" xmlns:xlink="http://www.w3.org/1999/xlink" class="bi bi-question-octagon-fill  me-1">
						<path d="m90,48c0,23.196-18.804,42-42,42s-42-18.804-42-42c0-10.224 3.678-19.569 9.75-26.85 .462-.852 1.104-1.593 1.905-2.13 .135-.141 .255-.3 .393-.438 .003,.069 .033,.135 .039,.204 .867-.486 1.851-.786 2.913-.786 3.312,0 6,2.688 6,6 0,2.088-1.065,3.924-2.685,4.998 .105,.078 .18,.174 .288,.252-4.125,5.136-6.603,11.649-6.603,18.75 0,16.569 13.431,30 30,30s30-13.431 30-30c0-7.101-2.478-13.614-6.603-18.75 .108-.078 .186-.174 .288-.252-1.62-1.074-2.685-2.91-2.685-4.998 0-3.312 2.688-6 6-6 1.062,0 2.046,.3 2.913,.786 .006-.069 .036-.135 .042-.204 .135,.138 .255,.297 .393,.438 .801,.537 1.44,1.278 1.905,2.13 6.066,7.281 9.747,16.626 9.747,26.85zm-39,6h-6c-1.659,0-3-1.341-3-3v-42c0-1.656 1.341-3 3-3h6c1.659,0 3,1.344 3,3v42c0,1.659-1.341,3-3,3z" />
					</svg>
		...
		<a class="nav-link collapsed d-flex desplegableAyuda <?= $vistaActiva == 'mantenimiento' ? 'active' : '' ?>" href="#" data-bs-toggle="collapse" data-bs-target="#collapseMantenimiento" aria-expanded="false" aria-controls="collapseMantenimiento">
			<div class="sb-nav-link-icon mx-2">
		...
		<div class="collapse " id="collapseMantenimiento" aria-labelledby="headingCitas" data-bs-parent="#sidenavAccordion d-flex">
			<nav class="sb-sidenav-menu-nested nav">
				<a class="nav-link mx-5" href="/Sistema-del--CEM--JEHOVA-RAFA/Mantenimiento/mantenimiento" uk-tooltip="Perfil">
					Mantenimiento
				</a>
