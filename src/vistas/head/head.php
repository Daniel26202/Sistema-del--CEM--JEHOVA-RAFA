...
<body class="d-flex">
	...
	<div class="aside-content bg-info">
		<div class="aside asideRespo active" id="aside">
			...
			<div class="options opcRes mt-1">
				...
				<?php if (!$this->permisos($_SESSION["id_rol"], "consultar", "Estadisticas")): ?>
					<!-- no hay -->
				<?php else: ?>
					<a href="/Sistema-del--CEM--JEHOVA-RAFA/Estadisticas/estadisticas" uk-tooltip="Reportes Estadisticos" id="menuReportesEstadisticos">
						<div class="" id="menuReportesColor">
