...
<div class="caja-contenedor-tabla fondo-tabla p-3 mb-3 col-11 m-auto">
    <div class="col-12 caja-boton">
            ...
            <button class="btn-guardar-responsive  btn btn-primary btn-agregar-doctores col-8" uk-toggle="target: #modal-examplecita" id="">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        <!-- editar -->
                                        <div class="me-2">
                                            <a href="#" class="btns-accion botonesEditar <?= $vistaActiva == 'realizadas'  ? ' d-none ': '' ?>"
