    ...
    <div class="caja-contenedor-tabla fondo-tabla p-3 mb-3 m-auto caja-contenedor-tabla" style="width: 95%; ">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center align-items-md-start">
            <div class="mb-2 mb-md-0 caja-btn-margin">
                ...
                <button class="caja-btn-margin btn btn-modals btnOpenModal" style="width: 100% !important" data-bs-toggle="modal" data-bs-target="#exampleModalCita" btn-guardar-responsive btn btn-primary btn-agregar-doctores col-8 <?= $vistaActiva == "realizadas" ? "d-none" : ""; ?>" uk-toggle="target: #modal-examplecita" id="btnAgendarCita">
