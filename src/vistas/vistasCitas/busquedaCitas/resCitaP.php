  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-1 0a7 7 0 1 0-13.202 3.249l1.988-1.657a4.5 4.5 0 0 1 7.537-4.623L7.497 6.5l1 2.5 1.333 3.11c-.56.251-1.18.39-1.833.39a4.49 4.49 0 0 1-1.592-.29L4.747 14.2A7 7 0 0 0 15 8Zm-8.295.139a.25.25 0 0 0-.288-.376l-1.5.5.159.474.808-.27-.595.894a.25.25 0 0 0 .287.376l.808-.27-.595.894a.25.25 0 0 0 .287.376l1.5-.5-.159-.474-.808.27.596-.894a.25.25 0 0 0-.288-.376l-.808.27.596-.894Z"/>
		...
		<div class="uk-nav uk-dropdown-nav"  uk-dropdown="pos: top-right" id="desplegable2">
			<ul >
				...
				<li><a href="#" id="btnayudaCitaPBuscador"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-question-octagon-fill azul me-1" viewBox="0 0 16 16" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="m-3 me-4 d-flex justify-content-end">
                ...
                <a href="?c=ControladorInicio/inicio&cerrar" class="btn btn-primary text-decoration-none text-decoration-none">Salir</a>
            </div>
        </div>
    </div>
</div>
...
<div class="div-tabla contenedor m-auto mt-3">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="mt-4">
        <a href="?c=controladorCitas/citas" class="text-decoration-none" uk-tooltip="Retroceder">
            <button class="btnRetroceder" id="btnRetrocederCita"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-reply-fill azul" viewBox="0 0 16 16">
        ...
        <table class="table table-striped" id="tabla">
            ...
            <?php if($datosCitas) : ?>
                <?php foreach ($datosCitas as $datoCita): ?>
                    <tr>
                    <td class="text-center"><?= $datoCita["nacionalidad"]; ?>-<?= $datoCita["cedula_p"]; ?></td>
                        ...
                        <td class=" text-center border-start d-none"><?= $datoCita["hora"]; ?></td>
                        ...
                        <td class="border-start">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <div class="me-2">
                                    ...
                                    uk-tooltip="Editar Cita" id="btnEditarCitaPendiente">
...
<div class="mt-3 uk-text-right">
    ...
    <a class="btn col-3 btn-agregarcita-modal text-decoration-none" href="?c=controladorCitas/eliminarCita&id_cita=<?= $datoCita["id_cita"]; ?>">Eliminar</a>
</div>
...
<form class="form-modal" action="?c=controladorCitas/editarCita" method="POST">
...
<input class="form-control input-modal fecha" id="fechaEditar" required pattern="\d{2}\/\d{2}\/\d{4}" maxlength="4" type="date" name="fecha" placeholder="Fecha" value="<?= $datoCita["fecha"]?>">
...
<input class="form-control input-modal" type="time" required name="hora" placeholder="Hora"  value="<?= $datoCita["hora"]?>">
</div>
...
<tr>
  <td colspan="9" class="text-center">El PACIENTE NO TIENE CITAS PENDIENTES
  </td>
</tr>
<?php endif ?>
...
<script type="text/javascript" src="./src/assets/js/ayudaCitasPendientesBuscador.js"></script> 
