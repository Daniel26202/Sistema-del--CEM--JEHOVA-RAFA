...
<div id="modal-exampleEliminarcita<?= $datoCita["id_cita"]; ?>" uk-modal>
    ...
    <div>
        <h5>
            ¿Desea Eliminar la Cita del Día de Hoy?
        </h5>
    </div>
</div>
...
<form class="form-modal" action="?c=controladorCitas/editarCitaHoy" method="POST">
...
<tr>
  <td colspan="9" class="text-center">El PACIENTE NO TIENE CITAS PENDIENTES PARA HOY
...
<script type="text/javascript" src="./src/assets/js/ayudaCitasHoyBuscador.js"></script> 
