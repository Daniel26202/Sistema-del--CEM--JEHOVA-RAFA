    ...
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" autohide: false id="myToast">
      <div class="toast-body">
        ...
        <div class="mt-2 pt-2 border-top">
          ...
          <button type="button" class="uk-button me-3 uk-button-default btn-cerrar-modal" data-bs-dismiss="toast">Cancelar</button>
        </div>
      </div>
    </div>
</div>
<form class="form-modal" action="?c=controladorCitas/guardarCita" id="modalAgregarCita" method="POST" autocomplete="off">

    <div class="input-group flex-nowrap" id="grp_cedula">

    
<img src="./assets/img/seguro-de-salud.png" width="60" height="60" uk-svg class="iconoB me-2" id="imgCita">
    ...
    <input class="form-control input-modal input-disabled" type="number" name="cedula" placeholder="Cedula" id="cedulaCita" required>
    <span class="d-none"  id="pacienteCitas">
...
<select class="form-control input-modal" name="consulta" id="especialidad" required>
    ...
    <?php foreach ($especialidades as $especialidad): ?>
        <option value="<?php echo $especialidad["0"] ?>"><?php echo $especialidad["1"] ?></option>
    <?php endforeach ?>
</select>
</div>
...
<div class="input-modal mt-3">
  ...
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zm9.954 3H2.545c-.3 0-.545.224-.545.5v1c0 .276.244.5.545.5h10.91c.3 0 .545-.224.545-.5v-1c0-.276-.244-.5-.546-.5zM8.5 7a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zm3 0a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zM3 10.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5zm3.5-.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1z"/>
        ...
        <div class="alert alert-danger d-flex align-items-center justify-content-center d-none" role="alert" id="alertahorarioCita">
...
<input class="form-control input-modal" type="date" name="fecha" id="fecha" placeholder="Fecha" required>
...
<input class="form-control input-modal" type="time" id="horaCita" name="hora" placeholder="Hora" required>
</div>
...
<input class="form-control input-modal input-disabled" type="hidden" name="estado" placeholder="Estado"
value="Pendiente">
...
<div class="mt-3 uk-text-right">
    ...
    <button class="btn col-3 btn-agregarcita-modal" type="submit" id="btnAgregarCita">Agregar</button>
</div>
</form>
</div>
</div>
...
<form class="form-modal" id="modalAgregarControl">
    ...
    <input class="form-control input-modal input-disabled" type="text" name="cedula" id="cedulaControl" placeholder="Cedula">
</div>
    ...
    <ul uk-accordion="multiple: true">
        <li>
            ...
            <div class="uk-accordion-content">
                <p id="datosPaciente"></p>
                <p id="edad">Edad:</p>
                <p id="patologia">Patologías:</p>
            </div>
        </li>
    </ul>
</div>
...
<div class="form-floating input-modal">
    ...
    id="floatingTextarea2" style="height: 50px;" name="sintomas"></textarea>
...
<div class="form-floating input-modal">
    <textarea class="form-control border-0 input-modal" placeholder="Leave a comment here"
    id="floatingTextarea2" style="height: 50px;" name="diagnostico"></textarea
    >
    <label for="floatingTextarea2">
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
...
<div class="form-floating input-modal">
    <textarea class="form-control border-0 input-modal" name="indicaciones" placeholder="Leave a comment here"
...
<input class="form-control input-modal" type="date" name="fechaRegreso" placeholder="Fecha"
