          ...
          <?php foreach ($datosPatologias as $patologia): ?>
            <tr>
              ...
              <td class="text-center">
                ...
                <button class="btn btn-tabla btn-dt-tabla mb-1" uk-toggle="target: #eliminarEspecialidad<?= $patologia["0"]; ?>"
                  id="btnEliminarEspecialidad" data-id-tabla="eliminarEspecialidad<?= $patologia["0"]; ?>">
                  ...
                  <div class="uk-modal-dialog uk-modal-body tamaño-modal">
                    ...
                    <div class="d-flex justify-content-between mb-5">
                      ...
                      <div class="d-flex align-items-center ajustar" id="eliminarEspecialidad">
                        ...
                        <div>
                          <h5>
                            ¿Desea restablecer la Patología?
                          </h5>
                        </div>
                      </div>
                      <!-- Ayuda Interactiva -->
