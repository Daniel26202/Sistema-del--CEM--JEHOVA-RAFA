...
<div class="div-tabla contenedorII m-auto mt-3" id="alertas">
        ...
        <ul class="sin-circulos d-flex justify-content-end">
            ...
            <li class="li">
                ...
                <div class="hover-grande">
                    <a href="/Sistema-del--CEM--JEHOVA-RAFA/Patologias/papeleraPatologias" class="text-decoration-none text-black me-3" id="DMservicioMedico">
  ...
  <div class="d-flex justify-content-between align-items-center">
    ...
    <div class="mover-input-agregarcita responsive_patologia mt-4">
      <button class="btn btn-primary btn-agregar-doctores col-11" uk-toggle="target: #modal-exampleAgregarPatologias" id="">
    ...
    <div class="mover-input-buscar mt-4 validar ">
      <form action="?c=ControladorPacientes/mostrarPaciente" method="POST" id="form-buscador-patologia" class="d-flex justify-content-end" autocomplete="off">
        ...
        <input class="form-control input-buscar tamaño-input-buscar buscador_responsiv" type="text" name="cedula" placeholder="Patología" required  id="inputB">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-x-circle uk-modal-close-default azul " viewBox="0 0 16 16">
        ...
        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                      ...
                      <div class="mt-5 uk-text-right btn_modal_patologias">
                        ...
                        <a href="/Sistema-del--CEM--JEHOVA-RAFA/Patologias/eliminarPatologia/<?= $patologia["0"]; ?>/<?php echo $_SESSION['id_usuario'] ?>">
                          <button class="btn col-4 btn-agregarcita-modal btnrestablecer" id="btnEliminarEspecialidad">Eliminar</button>
                        </a>
