<!-- MODAL DE AGREGAR INSUMOS editando -->
        ...
        <div class="modal-content rounded-4 pt-3 pb-3 pe-4 ps-4">
            ...
            <div class=" d-flex justify-content-between align-items-center mt-2 pt-0">
                ...
                <div class=" d-flex justify-content-center align-items-center ">
                    ...
                    <h4 class=" fw-bold ">Agregar insumo Editar</h4>
                </div>
            ...
            <div class="mb-5 pb-2">
                <form class="me-3 ms-3 mt-2" method="POST" action="?c=ControladorHospitalizacion/agregarH">
                    <div class="d-flex justify-content-between align-items-center mt-1 ">
                        ...
                        <div class="col-6">
                            <p class="ms-3 mt-4 fw-bolder " id="p-no-insumosE"></p>
                        </div>

                        <div class="d-flex justify-content-end mt-4 mb-3 col-6">
                            <input class="form-control input-buscar" type="text" name="nombre"
                                placeholder="Ingrese nombre" id="btbtE">
                            <a href="#" class="btn btn-buscar" title="Buscar" id="btn-buscarInsumoE">
                ...
                <div class="" id="">
                    ...
                    <div class="d-flex flex-wrap" id="insumoExisteE"></div>

                    <div class="d-flex flex-wrap" id="insumosE">

                        <?php if ($datosI): ?>
                            <?php foreach ($datosI as $datoI): ?>
                                <div class="col-6 divInsumosE" data-index=<?php echo $datoI["id_insumo"]; ?>>
