<!-- ====================================================
     MODAL: AGREGAR HOSPITALIZACIÓN (Bootstrap puro, sin UIKit)
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content tamaño-modal hospit">
            ...
            <?php if (empty($doctores)): ?>
                <form class="modal-body form-validable" id="formularioAgregarH" method="" action="#">
                <?php else: ?>
                    ...
                    <div class="d-none" id="contenedorFormAgregar">
                        ...
                        <div class="campo-custom">
                            <div class="input-custom" style="align-items: flex-start;">
                                ...
                                <textarea name="historial" class="txt-custom" rows="4"
                        ...
                        <div class="campo-custom">
                            <div class="input-custom">
                                ...
                                <select class="txt-custom select-custom" id="severidad" name="severidad" required>
                        ...
                        <div class="campo-custom">
                            <div class="input-custom" style="align-items: flex-start;">
                                ...
                                <textarea class="txt-custom" rows="3" placeholder="Diagnóstico del paciente"
...
<!-- antiguo -->
<div class="modal fade " id="" data-bs-keyboard="false" tabindex="-1"
