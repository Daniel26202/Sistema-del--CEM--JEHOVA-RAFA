...
<div class="modal fade" id="modal-agregar-hospitalizacion" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-md" id="divModal">
        <div class="modal-content tamaño-modal hospit">
            ...
            <div class="modal-header border-0 pb-0">
                <div class="d-flex align-items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor"
                        ...
                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1
                        0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3z"/>
                    </svg>
            ...
            <form class="modal-body form-validable" id="formularioAgregarH" method="POST" action="#">
                                ...
                                <div class="input-custom" id="divGrp_cedula">
                                    <span class="icono-izq">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                            ...
                                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm9
                                            1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5ZM9 8a.5.5 0 0 0 .5.5h4a.5.5
                                            0 0 0 0-1h-4A.5.5 0 0 0 9 8Zm1 2.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5Z
                                            m-1 2C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 0 2 13h6.96
                                            c.026-.163.04-.33.04-.5ZM7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0Z"/>
                                        </svg>
                                    </span>
                                    <select class="form-control-plaintext tamaño-select-mini inputs"
                                        id="nacionalidadH" name="nacionalidad">
                                        <option value="V" selected>V</option>
                                        <option value="E">E</option>
                                    </select>
                                    <input class="form-control txt-custom input-validar inputs w-100"
                                        type="number" name="cedula" id="bt"
                                        placeholder="Cédula del paciente" maxlength="8" minlength="6">
                                    <span class="icono-der">
                                        <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                            ...
                                            1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0
                                            0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247
                                            0 0 1 .02-.022Z"/>
                                        </svg>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-7 ps-3 pt-0 pt-lg-3">
                            <a href="#" id="inforPaciente"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                                    ...
                                    2-2V2a2 2 0 0 0-2-2zM5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1zm-.5
                                    2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zM5 8h6a.5.5
                                    0 0 1 0 1H5a.5.5 0 0 1 0-1zm0 2h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1z"/>
                                </svg>
                            ...
                            <a href="#" class="d-none text-decoration-none fw-bold azul" id="aPaciente"
                                data-bs-toggle="modal" data-bs-target="#modal-examplePaciente"
                ...
                <!-- RESTO DEL FORMULARIO (aparece al encontrar paciente) -->
                <div class="d-none" id="contenedorFormAgregar">
                        ...
                        <div class="input-custom">
                            <span class="icono-izq">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                    ...
                                    <path d="M10 .5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5.5.5 0 0 1-.5.5.5.5
                                    0 0 0-.5.5V2a.5.5 0 0 0 .5.5h5A.5.5 0 0 0 11 2v-.5a.5.5 0 0 0-.5-.5.5.5
                                    0 0 1-.5-.5"/>
                                    <path d="M4.085 1H3.5A1.5 1.5 0 0 0 2 2.5v12A1.5 1.5 0 0 0 3.5 16h9a1.5
                                    1.5 0 0 0 1.5-1.5v-12A1.5 1.5 0 0 0 12.5 1h-.585q.084.236.085.5V2a1.5
                                    1.5 0 0 1-1.5 1.5h-5A1.5 1.5 0 0 1 4 2v-.5q.001-.264.085-.5m6.769
                                    6.854-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5
                                    9.793l2.646-2.647a.5.5 0 0 1 .708.708"/>
                                </svg>
                            </span>
                            <?php if (empty($doctores)): ?>
                            ...
                            <?php else: ?>
                                <select class="txt-custom select-custom input-validar" name="id_personal"
                                    id="doctorS" required>
                    ...
                    <a href="#" class="d-flex align-items-center justify-content-center gap-2 text-decoration-none color-icono azul"
                        id="btnASA" data-bs-toggle="modal" data-bs-target="#modal-servicios-uni"
                        data-contexto="agregar">
                    ...
                    <!-- Cards de servicios seleccionados (JS las inserta) -->
                    ...
                    <a href="#" class="d-flex align-items-center justify-content-center gap-2 text-decoration-none color-icono azul"
                        id="btnAIA" data-bs-toggle="modal" data-bs-target="#modal-insumos"
                        data-contexto="agregar">
                        <i class="bi bi-plus-circle fs-4"></i>
                        <span>Agregar insumos</span>
                    </a>
                    <!-- Cards de insumos seleccionados (JS las inserta) -->
                    <div class="row g-3 mb-3" id="div-insumosA"></div>
                        ...
                        <div class="input-custom">
                            <span class="icono-izq">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                    ...
                                    <path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5
                                    0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964
                                    4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2z"/>
                                </svg>
                            </span>
                            <select class="txt-custom select-custom input-validar" id="severidad"
                                name="severidad" required>
                    ...
                    <div class="campo-custom">
                        <div class="input-custom" style="align-items: flex-start;">
                            ...
                            <textarea class="txt-custom input-validar" rows="3"
