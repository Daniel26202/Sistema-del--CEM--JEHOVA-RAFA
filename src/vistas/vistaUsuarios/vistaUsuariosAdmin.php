  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-1 0a7 7 0 1 0-13.202 3.249l1.988-1.657a4.5 4.5 0 0 1 7.537-4.623L7.497 6.5l1 2.5 1.333 3.11c-.56.251-1.18.39-1.833.39a4.49 4.49 0 0 1-1.592-.29L4.747 14.2A7 7 0 0 0 15 8Zm-8.295.139a.25.25 0 0 0-.288-.376l-1.5.5.159.474.808-.27-.595.894a.25.25 0 0 0 .287.376l.808-.27-.595.894a.25.25 0 0 0 .287.376l1.5-.5-.159-.474-.808.27.596-.894a.25.25 0 0 0-.288-.376l-.808.27.596-.894Z"/>
    ...
    <div class="d-flex justify-content-center">
        ...
        <?php if (isset($_GET["error"])): ?>
            <div class="uk-alert-danger comentario comentarioRed me-3 ms-5 fw-bolder h-25"
                uk-alert>
...
<div class="modal fade" id="eliminar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="fondo-tabla">
        ...
        <div class="">
        <button class="btn btn-primary btn-agregar-doctores col-11" uk-toggle="target: #modal-exampleAgregar" id="btnRegistrarPaciente">
                ...
                <ul class="sin-circulos d-flex justify-content-end">
                    ...
                    <li class="li">
                        ...
                        <div class="hover-grande">
                            <a href="?c=ControladorUsuarios/usuarios" class="text-decoration-none text-black me-3 " id="DMservicioMedico">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-person-square ms-2 " viewBox="0 0 16 16">
                                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                    <path
                    ...
                    <li class="li">
                        ...
                        <div class="hover-grande">
                            <a href="?c=ControladorUsuarios/administradores" class=text-decoration-none  me-3 azul me-3 iconoDoctor" id="DMdoctores">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-person-square ms-2" viewBox="0 0 16 16">
                                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                    <path
