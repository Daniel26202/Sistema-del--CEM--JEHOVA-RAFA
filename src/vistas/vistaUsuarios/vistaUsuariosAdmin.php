        ...
        <div class="d-flex flex-wrap justify-content-center ms-5 me-5">
            <?php if ($datosU): ?>
                ...
                <?php foreach ($datosU as $dato): ?>
                    ...
                    <div
                        class="card contenido col-9 col-sm-6 col-lg-3 tarjeta ms-2 me-4 d-flex align-items-center justify-content-center tarjeta">
                        ...
                        <?php else: ?>
                            ...
                            <img src="<?= $urlBase ?>../src/assets/img_ingresadas_por_usuarios/usuarios/<?= $dato['imagen'] ?>" class="mt-2"
                                alt="...">
                        <?php endif; ?>
                        <div class="mt-3">
