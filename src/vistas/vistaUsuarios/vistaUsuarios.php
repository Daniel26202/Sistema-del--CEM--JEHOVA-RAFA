                ...
                <ul class="sin-circulos d-flex justify-content-end">
                    ...
                    <li class="li">
                        ...
                        <div class="hover-grande">
                            <a href="?c=ControladorUsuarios/usuarios" class="text-decoration-none me-3 azul" id="DMservicioMedico">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-person-square ms-2 " viewBox="0 0 16 16">
                                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                    <path
                    ...
                    <li class="li">
                        ...
                        <div class="hover-grande">
                            <a href="?c=ControladorUsuarios/administradores" class="text-decoration-none text-black me-3 iconoDoctor" id="DMdoctores">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-person-square ms-2" viewBox="0 0 16 16">
                                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                    <path
