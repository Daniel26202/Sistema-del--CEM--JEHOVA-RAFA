...
<div class="col-12 m-auto pt-3 contenedor-fondo" style="height: 100vh;">
    ...
    <div class="caja-contenedor-tabla fondo-tabla p-3 mb-3 m-auto" style="width: 95%; ">
        ...
        <div class="me-2 ps-3 col-12 caja-boton d-flex justify-content-between align-items-center row ">
            ...
            <button class=" caja-btn-margin btn btn-modals col-2 <?= $vistaActiva == "papelera" ? 'd-none' : '' ?>" data-bs-toggle="modal" data-bs-target="#exampleModalagregarDocotor" id="btnagregarDoctor">
