        ...
        <form class="me-2 ms-2" method="POST" action="/Sistema-del--CEM--JEHOVA-RAFA/Doctores/agregarDoctor" id="modalAgregarDoctores"
            ...
            <div class="col w-auto mt-4 mb-4 pb-1">
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input class="form-control input-modal input-disabled input " type="file" name="imagenDoctores"
                        id="imagenDoctores" placeholder="Imagen">
                </div>
                ...
                <div class="input-group flex-nowrap margin-inputs ">
                    ...
                    <input type="number" name="cedula" id="inputUno" class="form-control input-modal input-disabled input-paciente input" placeholder="Cédula">

                </div>
                <div class="margen-input w-auto">
                    ...
                    <input type="text" name="nombre" id="inputDos" class="input inputA mayuscula" placeholder="Nombre">
                ...
                <div class="margen-input w-auto">
                    ...
                    <input type="text" name="apellido" id="inputTres" class="input inputA mayuscula" placeholder="Apellido">
                ...
                <div class="margen-input w-auto">
                    ...
                    <input type="text" name="telefono" id="inputCuatro" class="input inputA" placeholder="Teléfono">
                ...
                <div class="margen-input w-auto">
                    ...
                    <input type="email" name="email" class="input inputA" placeholder="E_mail">
                ...
                <?php else: ?>
                    <div class="margen-input ">
                        ...
                        <select name="selectEspecialidad" class="input inputA selectEspecialidad" placeholder="Especialidad" required>
                ...
                <div class="margen-input w-auto">
                    ...
                    <input type="text" name="usuario" id="inputDos" class="input inputA" placeholder="Usuario">

                </div>
                <div class="margen-input w-auto d-flex">

                    <img src="./src/assets/img/candado.svg" id="icono-dos" class="icono" alt="">

                    <input type="password" name="password" id="passwordMostrar" class="input inputA" placeholder="Contraseña">
                                    ...
                                    <?php foreach ($datosDias as $dia): ?>
                                        ...
                                        <div class="d-flex w-50 justify-content-between mb-3">
                                            ...
                                            <div style="width: 60%;">
                                                ...
                                                <div>
                                                    <input type="time" class="input-dias hora-entrada inputHorario d-none input inputA" title="Hora De Entrada <?= $dia['diaslaborables'] ?>">
                                                    <input type="time" class="input-dias hora-salida inputHorario mt-2 d-none input inputA" title="Hora De Salida <?= $dia['diaslaborables'] ?>">
                                                </div>
                ...
                <div class="d-flex align-items-center justify-content-center pe-3 ps-1 d-none" id="leyendaHoraA">
                    ...
                    <i>La hora de salida tiene que ser más tarde que la hora de entrada.
                    </i>
                </div>
...
<div id="modal-agregar-doctore" uk-modal class="">
        ...
        <div class=" d-flex justify-content-between align-items-center mt-2 pt-0">
            ...
            <div class=" d-flex justify-content-center align-items-center ">
                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor"
                    class="bi bi-plus-circle-fill color-icono me-1 mb-1" viewBox="0 0 16 16">
                    <path
                        d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3z" />
                </svg>
                <h4 class="">Agregar Doctor</h4>
            </div>
            <div>
        ...
        <form class="me-2 ms-2" method="POST" action="/Sistema-del--CEM--JEHOVA-RAFA/Doctores/agregarDoctor" id="modalAgregarDoctores"
            ...
            <div class="col w-auto mt-4 mb-4 pb-1">
                ...
                <div class="d-flex flex-column w-auto ">
                    ...
                    <div class="margen-input mt-3 w-auto d-flex grp_cedula">

                        <svg xmlns="http://www.w3.org/2000/svg" id="icono-uno" width="20" height="20"
                            fill="currentColor" class="bi bi-person-fill icono" viewBox="0 0 16 16">
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                        </svg>
                        <select class="input inputA" aria-label="2" placeholder="Nacionalidad" name="nacionalidad"
                            style="width: 70px;">
                            <option value="V" selected>V</option>
                            <option value="E">E</option>
                        </select>
                        <input type="number" name="cedula" id="inputUno" class="input inputA" placeholder="Cédula">
