<!-- Modal Agregar-->
<div class="modal fade" id="exampleModalagregarDocotor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content tamaño-modal">
            ...
            <div class="modal-body">
                <form class=" form-validable" id="modalAgregarDoctores">
                    ...
                    <div class="campo-custom">
                        <div class="input-custom">
                            ...
                            <input class="form-control txt-custom input-validar campo-editar" id="cedulaPaciente" name="cedula" type="number" placeholder="Cédula del doctor">
                    ...
                    <div class="campo-custom">
                        <div class="input-custom">
                            ...
                            <input class="form-control txt-custom input-validar inputs campo-editar" name="nombre" type="text" placeholder="Nombre del doctor">
                            <span class="icono-der">
                                <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                </svg>
                    ...
                    <div class="campo-custom">
                        <div class="input-custom">
                            ...
                            <input class="form-control txt-custom input-validar inputs campo-editar" name="apellido" type="text" placeholder="Apellido del doctor">
                            <span class="icono-der">
                                <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                </svg>
                    ...
                    <div class="campo-custom">
                        <div class="input-custom">
                            ...
                            <input class="form-control txt-custom input-validar inputs campo-editar" name="telefono" type="number" placeholder="Teléfono del doctor">
                            <span class="icono-der">
                                <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                </svg>
                    ...
                    <label class="label-custom">Seleccionar la Especialidad</label>
                    <div class="campo-custom">
                        <div class="input-custom">
                            <span class="icono-izq">
                            ...
                            <select class="form-control txt-custom select-custom input-validar inputs campo-editar" name="id_especialidad">
                                <option class="option-select-background" selected="" value="">Seleccionar la Especialidad</option>
                                <?php foreach ($datosEspecialidades as $e): ?>
                                    <option class="option-select-background" value="<?php echo $e['id_especialidad'] ?>">
                                        <?php echo $e['nombre'] ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
...
<!-- designar servicio medico -->

<!-- Modal Agregar-->
<div class="modal fade" id="modal-designar-servicio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content tamaño-modal">
            <div class="modal-header">
                <h5 class="modal-title fs-4 fw-bold" id="exampleModalLabelDoctores">Asignar Servicio al Doctor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class=" form-validable" id="formAsignarServicio">


                    <input type="hidden" name="id_usuario_bitacora" value="<?= $_SESSION['id_usuario'] ?>">


                    <label class="label-custom">Seleccionar el Doctor</label>
                    <div class="campo-custom">
                        <div class="input-custom">
                            <span class="icono-izq">
                            ...
                            <select class="form-control txt-custom select-custom input-validar inputs campo-editar" id="select-doctor" name="id_doctor">
                    ...
                    <label class="label-custom">Seleccionar la Servicio Medico</label>
                    <div class="campo-custom">
                        <div class="input-custom">
                            <span class="icono-izq">
                            ...
                            <select class="form-control txt-custom select-custom input-validar inputs campo-editar" id="select-servicio" name="id_categoria">
                                <option class="option-select-background" selected="" value="">Seleccionar el Servicio Medico</option>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-modals-cancelar me-2" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-modals" id="botonModal">Asignar</button>
                    </div>
                </form>
            </div>
        </div>
