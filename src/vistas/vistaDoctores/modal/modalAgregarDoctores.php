        ...
        <form class="me-2 ms-2" method="POST" action="/Sistema-del--CEM--JEHOVA-RAFA/Doctores/agregarDoctor" id="modalAgregarDoctores"
            ...
            <div class="col w-auto mt-4 mb-4 pb-1">
                ...
                <div class="input-group flex-nowrap margin-inputs">
                    ...
                    <input type="text" name="usuario" id="inputDos" class="form-control input-modal input-disabled inputA" placeholder="Usuari">
                                    ...
                                    <?php foreach ($datosDias as $dia): ?>
                                        ...
                                        <div class="d-flex w-50 justify-content-between mb-3">
                                            ...
                                            <div style="width: 60%;">
                                                ...
                                                <div>
                                                    <input type="time" class="input-dias hora-entrada inputHorario d-none form-control input-modal input-disabled input inputAA" title="Hora De Entrada <?= $dia['diaslaborables'] ?>">
