      ...
      <li class="li">
        ...
        <div class="hover-grande">
          <a href="/Sistema-del--CEM--JEHOVA-RAFA/Insumos/insumos" class="text-decoration-none text-black me-3" id="DMservicioMedico">
            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-capsule me-1 azul" viewBox="0 0 16 16">
              <path d="M1.828 8.9 8.9 1.827a4 4 0 1 1 5.657 5.657l-7.07 7.071A4 4 0 1 1 1.827 8.9Zm9.128.771 2.893-2.893a3 3 0 1 0-4.243-4.242L6.713 5.429l4.243 4.242Z" />
            </svg>Insumos</a>
          </div>
        </li>
                ...
                <div class="contenedor_tabla_entradas tamaño_tabla mt-4">
                  <table class="table table-striped">
                    ...
                    <tbody id="tablaEntradas">
                            ...
                            <div id="eliminarEntrada<?= $e["id_insumo"]; ?>" uk-modal>
                              <div class="uk-modal-dialog uk-modal-body tamaño-modal">
                                ...
                                <div class="mt-5 uk-text-right btn_modal_patologias">
                                  ...
                                  <a href="?c=controladorInsumos/restablecerInsumo&id_insumo=<?= $e["id_insumo"]; ?>&id_usuario_bitacora=<?= $_SESSION['id_usuario']?>">
                      ...
                      <?php else: ?>
                        <tr>
                          <th colspan="8" class="text-center">NO HAY REGISTROS</th>
                        </tr>
                      <?php endif ?>
                    </tbody>
                  </table>
