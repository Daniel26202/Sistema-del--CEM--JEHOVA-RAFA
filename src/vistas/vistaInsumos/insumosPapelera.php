          ...
          <?php foreach ($desactivos as $e) : ?>
            <tr>
              ...
              <td class="d-flex justify-content-center">
                ...
                <button class="btn btn-tabla mb-1 btn-dt-tabla" uk-toggle="target: #eliminarEntrada<?= $e["id_insumo"]; ?>"
                  id="btnEliminarEspecialidad" data-id-tabla="eliminarEntrada<?= $e["id_insumo"]; ?>">
