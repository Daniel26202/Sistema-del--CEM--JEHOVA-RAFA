            ...
            <div class="modal-body">
                <form id="modalInfo">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <!-- Botón Editar -->
                        <div class="me-3">
                            <a href="#" class="btns-accion" data-bs-toggle="modal" data-bs-target="#exampleModalEditarInsumos">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-pencil-square azul" viewBox="0 0 16 16">
                        ...
                        <!-- Botón Eliminar -->
                        <div class="me-2">
                            <a href="#" class="btns-accion btn-eliminar" title="Eliminar Insumo">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash3 azul" viewBox="0 0 16 16">
