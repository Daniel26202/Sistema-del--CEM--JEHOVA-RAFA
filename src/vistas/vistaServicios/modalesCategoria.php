    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content tamaño-modal">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-modals" id="openBotonModalServicio" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modalAgregarPatologias">Registrar</button>
            ...
            <form class="form-modal form-validable form-convercion" autocomplete="off" id="formularioCategoria">
                ...
                <div class="campo-custom">
                    <div class="input-custom">
                        ...
                        <input class="form-control txt-custom input-validar inputs " name="categoria" type="text" placeholder="Nombre de la Categoría" required maxlength="20">
