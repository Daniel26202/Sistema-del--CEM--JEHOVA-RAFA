<div id="modal-sintomas" uk-modal>
  <div class="uk-modal-dialog uk-modal-body tamaño-modal">
    <!-- Boton que cierra el modal -->
    <div class="d-flex justify-content-between ">


      <div class="d-flex align-items-center mb-3" id="sintomasAyuda">
        <div>
      ...
      <div class="d-flex justify-content-end mb-3">
        <a href="#" uk-tooltip="Ayuda">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
            class="bi bi-question-octagon-fill azul ms-4" viewBox="0 0 16 16" id="btnAyudaSintomas">
            <path
    ...
    <div class="d-flex justify-content-end">
      <div class="d-flex justify-content-end mb-4 col-6" id="form-buscadorS">
    ...
    <div class="">
      <table class="table table-striped tabla" id="tablaSintomas">
        <thead>
          <tr>
            <th class="d-none">
              Id
        ...
        <tbody id="" class="tbodyS">

          <?php if ($datosS): ?>
            <?php $contadorSintomas = 1; ?>

            <?php foreach ($datosS as $sintomas): ?>

              <tr>
                <td class="text-center fw-bold">
                  <?php echo $contadorSintomas++; ?>
                </td>

                <td class="text-center border-start">
                  <?php echo $sintomas['nombre']; ?>
                </td>


                <td class="border-start text-center">
                  <button class="btn btn-tabla mb-1" uk-toggle="target: #eliminarSintoma<?= $sintomas["id_sintomas"]; ?>"
                    id="btnEliminarSintomas">
                  ...
                  <!-- modal eliminar -->
                  <div id="eliminarSintoma<?= $sintomas["id_sintomas"]; ?>" uk-modal>
                    <div class="uk-modal-dialog uk-modal-body tamaño-modal">
                      <!-- Boton que cierra el modal -->
                      <div class="d-flex justify-content-between mb-5">
                        ...
                        <div class="d-flex align-items-center" id="eliminarSintomas">
                          <div>
                        ...
                        <div>
                          <a href="#" uk-tooltip="Ayuda">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                              class="bi bi-question-octagon-fill azul ms-4" viewBox="0 0 16 16" id="btnAyudaSintomas3">
                              <path
                                d="M11.46.146A.5.5 0 0 0 11.107 0H4.893a.5.5 0 0 0-.353.146L.146 4.54A.5.5 0 0 0 0 4.893v6.214a.5.5 0 0 0 .146.353l4.394 4.394a.5.5 0 0 0 .353.146h6.214a.5.5 0 0 0 .353-.146l4.394-4.394a.5.5 0 0 0 .146-.353V4.893a.5.5 0 0 0-.146-.353L11.46.146zM5.496 6.033a.237.237 0 0 1-.24-.247C5.35 4.091 6.737 3.5 8.005 3.5c1.396 0 2.672.73 2.672 2.24 0 1.08-.635 1.594-1.244 2.057-.737.559-1.01.768-1.01 1.486v.105a.25.25 0 0 1-.25.25h-.81a.25.25 0 0 1-.25-.246l-.004-.217c-.038-.927.495-1.498 1.168-1.987.59-.444.965-.736.965-1.371 0-.825-.628-1.168-1.314-1.168-.803 0-1.253.478-1.342 1.134-.018.137-.128.25-.266.25h-.825zm2.325 6.443c-.584 0-1.009-.394-1.009-.927 0-.552.425-.94 1.01-.94.609 0 1.028.388 1.028.94 0 .533-.42.927-1.029.927z" />
                            </svg>
                          </a>
    ...
    <div class="mt-3 uk-text-right">
      <button class="uk-button col-6 me-2 uk-button-default uk-modal-close btn-cerrar-modal" type="button"
        id="cerrarModalSintomas">CERRAR</button>
      <a href="#" class="text-decoration-none">
        <button class="btn col-5 btn-agregarcita-modal" id="botonAgregarSintomas"
          uk-toggle="target: #modal-exampleAgregarSintomas">Nueva</button></a>
...
<!-- modal agregar sintomas -->

<div id="modal-exampleAgregarSintomas" uk-modal>
  <div class="uk-modal-dialog uk-modal-body tamaño-modal">

    <div class="d-flex justify-content-between ">
      <div class="d-flex align-items-center mb-3" id="registrarSintomas">
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
            class="bi bi-mortarboard-fill azul me-3 mb-3 azul" viewBox="0 0 16 16">
            <path
      ...
      <div class="d-flex justify-content-end mb-3">
        <a href="#" uk-tooltip="Ayuda">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
            class="bi bi-question-octagon-fill azul ms-4" viewBox="0 0 16 16" id="btnAyudaSintomas2">
            <path
              d="M11.46.146A.5.5 0 0 0 11.107 0H4.893a.5.5 0 0 0-.353.146L.146 4.54A.5.5 0 0 0 0 4.893v6.214a.5.5 0 0 0 .146.353l4.394 4.394a.5.5 0 0 0 .353.146h6.214a.5.5 0 0 0 .353-.146l4.394-4.394a.5.5 0 0 0 .146-.353V4.893a.5.5 0 0 0-.146-.353L11.46.146zM5.496 6.033a.237.237 0 0 1-.24-.247C5.35 4.091 6.737 3.5 8.005 3.5c1.396 0 2.672.73 2.672 2.24 0 1.08-.635 1.594-1.244 2.057-.737.559-1.01.768-1.01 1.486v.105a.25.25 0 0 1-.25.25h-.81a.25.25 0 0 1-.25-.246l-.004-.217c-.038-.927.495-1.498 1.168-1.987.59-.444.965-.736.965-1.371 0-.825-.628-1.168-1.314-1.168-.803 0-1.253.478-1.342 1.134-.018.137-.128.25-.266.25h-.825zm2.325 6.443c-.584 0-1.009-.394-1.009-.927 0-.552.425-.94 1.01-.94.609 0 1.028.388 1.028.94 0 .533-.42.927-1.029.927z" />
          </svg>
        </a>
    ...
    <form class="form-modal form-validable" id="modalAgregar" action="/Sistema-del--CEM--JEHOVA-RAFA/Control/agregarSintoma" method="POST">
      ...
      <div class="mt-3 uk-text-right">
        <button class="uk-button col-6 me-2 uk-button-default btn-cerrar-modal" type="button"
          uk-toggle="target: #modal-sintomas" id="cancelarRegistroSintomas">Cancelar</button>
        <button class="btn col-5 btn-agregarcita-modal" type="sumit" name="crear"
          id="botonEnviarSintomas">Agregar</button>
      </div>
    </form>
  </div>
</div>
...
<script type="text/javascript" src="./src/assets/js/ayudaSintomas.js"></script>