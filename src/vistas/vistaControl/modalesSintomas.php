<!-- Modal Agregar-->
<div class="modal fade" id="exampleModalAgregarSintoma" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content tamaño-modal">
            ...
            <form class=" form-validable" id="modalAgregarSintoma">
                ...
                <div class="modal-body">
                    ...
                    <label class="label-custom">Nombre del Sintoma</label>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content tamaño-modal">
            ...
            <div class="table table-responsive">
                <table class="exampleTableSintoma table table-striped">
                    <thead>
                        <tr>
