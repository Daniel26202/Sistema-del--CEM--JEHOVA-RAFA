<div class="me-4 mt-0 desplegableAyuda">
    ...
    <div class="uk-nav uk-dropdown-nav contenido" uk-dropdown="pos: top-right" id="desplegable2">
        <ul>
            ...
            <li><a href="#" id="<?= isset($ayuda) ? $ayuda : "" ?>"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
            ...
            <li class="uk-nav-divider"></li>
            <li><a href="/Sistema-del--CEM--JEHOVA-RAFA/Bitacora/bitacora"><svg xmlns="http://www.w3.org/2000/svg"
                        width="25" height="25" fill="currentColor" class="bi bi-question-octagon-fill azul me-1"
                        viewBox="0 0 16 16">
                        <path
