...
<div id="modal-exampleAgregarPatologias" uk-modal>
    <div class="uk-modal-dialog uk-modal-body tamaño-modal">
        ...
        <form class="form-modal form-validable form-ajax" autocomplete="off" id="modalAgregarCategoria" >
            ...
            <div class="input-group flex-nowrap margin-inputs validar" id="grp_nombrePatologia">
                ...
                <input class="form-control mayuscula input-modal input-validar input-disabled input-paciente" type="text"
