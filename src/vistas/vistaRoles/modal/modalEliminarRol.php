<?php foreach ($roles as $rol): ?>
    ...
    <div id="modal-exampleEliminar<?php echo $rol["id_rol"]; ?>" uk-modal>
        <div class="uk-modal-dialog uk-modal-body tamaño-modal">
            <form class="" method="POST" action="/Sistema-del--CEM--JEHOVA-RAFA/Roles/eliminarRol">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5>
                            ¿Desea eliminar la Rol <?php echo $rol["nombre"]; ?>?
                        </h5>
                    </div>
                </div>

                <div>
                    <input type="" name="id_rol" value="<?php echo $rol["id_rol"]; ?>" hidden>
