...
<div class="col-12 m-auto pt-3 contenedor-fondo" style="height: 100vh;">
    ...
    <div class="caja-contenedor-tabla fondo-tabla p-3 mb-3 m-auto table-responsive" style="width: 95%; ">
        ...
        <div class="me-2 ps-3 col-12 caja-boton d-flex justify-content-between align-items-center row ">
            ...
            <div class=" d-flex justify-content-between ">
                ...
                <div class="caja-insumos mt-3">
                    <button class="btnOpenModalModulo caja-btn-margin btn btn-modals " data-bs-toggle="modal" data-bs-target="#gestionarModulo"
                        id="btnRegistrarModulo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor"
                            class="bi bi-person-square me-2" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path
                                d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-1c0-1-1-4-6-4s-6 3-6 4v1a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12z" />
                        </svg>Gestionar Modulos
                    </button>
                </div>

                <!-- Buscador de Insumos -->
                <div class=" d-flex mt-3 caja-insumos buscador-insumos">
    ...
    <script type="text/javascript" src="<?= $urlBase ?>../src/assets/js/ayudaInteractiva/ayudaRoles.js"></script>