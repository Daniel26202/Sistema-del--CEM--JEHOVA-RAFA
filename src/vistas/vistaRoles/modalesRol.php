...
<!-- Modal gestionar modulos-->

<!-- modal para mostrar todo -->
<div class="modal fade" id="gestionarModulo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content tamaño-modal">
            <div class="modal-header">
                <h5 class="modal-title fs-4 fw-bold" id="modalLabelServicios">Gestionar Modulos</h5>
                <!-- Ayuda interactiva -->
            ...
            <div class="">
                <table class="table exampleTableModulo table-striped " id="tablaPatologia">
                    <thead>
                        <tr>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-modals-cancelar me-2" data-bs-dismiss="modal">Cancelar</button>
                <button type="submit" class="btn btn-modals" id="openBotonModalServicio" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modalAgregarModulo">Registrar</button>
...
<div class="modal fade" id="modalAgregarModulo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content tamaño-modal">
            <div class="modal-header">
                <h5 class="modal-title fs-4 fw-bold" id="modalLabelServicios">Registrar Modulo</h5>
                <!-- Ayuda interactiva -->
                <div class="d-flex justify-content-end mb-3">
                    <a href="#" uk-tooltip="Ayuda">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
            ...
            <form class="form-modal form-validable form-convercion" autocomplete="off" id="formModulo">

                <input type="hidden" name="id_usuario" value="<?= $_SESSION['id_usuario'] ?>">

                <label class="label-custom">Nombre del Modulo</label>
                <div class="campo-custom">
                    <div class="input-custom">
                        <span class="icono-izq">
                        ...
                        <input class="form-control txt-custom input-validar inputs " name="nombre" type="text" placeholder="Nombre del Modulo" required maxlength="20">
                        <span class="icono-der">
                            <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                            </svg>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-modals" id="botonModalServicio" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modalAgregarModulo">Registrar</button>
                    <span id="spinner-cargando" class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                </div>
        </div>
    </div>
