        ...
        <div class="modal-dialog ">
            <div class="modal-content tamaño-modal">
                ...
                <form class=" form-validable" id="modalAgregarCliente">
                    ...
                    <input type="hidden" name="cedulaRegistrada" id="cedulaOculta">

                    <input type="hidden" name="id" id="id_oculto">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="campo-custom">
                            <div class="input-custom">
                                ...
                                <input class="form-control txt-custom input-validar inputs" name="cedula" type="number" placeholder="Cédula del Cliente">
                        ...
                        <div class="campo-custom">
                            <div class="input-custom">
                                ...
                                <input class="form-control txt-custom input-validar inputs" name="nombre" type="text" placeholder="Nombre del Cliente">
                                <span class="icono-der">
                                    <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                    </svg>
                        ...
                        <div class="campo-custom">
                            <div class="input-custom">
                                ...
                                <input class="form-control txt-custom input-validar inputs" name="apellido" type="text" placeholder="Apellido del Cliente">
                                <span class="icono-der">
                                    <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                    </svg>
                        ...
                        <div class="campo-custom">
                            <div class="input-custom">
                                ...
                                <input class="form-control txt-custom input-validar inputs" name="telefono" type="number" placeholder="Teléfono del Cliente">
                                <span class="icono-der">
                                    <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                    </svg>
                        ...
                        <div class="campo-custom">
                            <div class="input-custom">
                                ...
                                <input class="form-control txt-custom input-validar inputs" name="direccion" type="text" placeholder="Dirección del Cliente">
                                <span class="icono-der">
                                    <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                    </svg>
