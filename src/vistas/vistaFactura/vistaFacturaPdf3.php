...
$pdf->SetTextColor(14, 169, 181);
$pdf->Cell(85, 10,strtoupper( 'NOMBRE:  '.$datosFactura[0]['nombre'].' '.$datosFactura[0]['apellido']), 0, 0, 'L',0);
$pdf->Cell(85, 10, 'C.I:  '.$datosFactura[0]['nacionalidad'].'-'.$datosFactura[0]['cedula'], 0, 0, 'L',0);
...
$pdf->Cell(23, 10, strtoupper('SERVICIO:'), 0, 0, 'L',0);
$pdf->Cell(45, 10, utf8_decode('HOSPITALIZACIÓN'), 0, 0, 'L',0);
$pdf->Cell(67, 10, strtoupper('DOCTOR: '.$datosFactura[0]['nombre_d'].' '.$datosFactura[0]['apellido_d']), 0, 0, 'L',0);
$pdf->Cell(70, 10, strtoupper('PRECIO: '.$datosFactura[0]['precio_horas']* $datosFactura[0]["duracion"].' Bs'), 0, 0, 'L',0);
