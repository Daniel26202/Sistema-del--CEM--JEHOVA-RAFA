                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <!-- eliminar -->
                                    <div class="me-2">
                                        <button class="btn btn-tabla btnEliminarDoctor btn-dt-tabla mb-1" uk-toggle="target: #modal-exampleEntradaEliminar<?= $entrada["id_entradaDeInsumo"] ?>" data-id-tabla="modal-exampleEntradaEliminar<?= $entrada["id_entradaDeInsumo"] ?>" id="btnEliminarDoctor">
