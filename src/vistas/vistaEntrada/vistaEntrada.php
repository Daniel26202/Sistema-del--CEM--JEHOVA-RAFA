                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <!-- eliminar -->
                                    <div class="me-2">
                                        <button class="btn btn-tabla mb-1" uk-toggle="target: #modal-eliminar-pacientes23" id="btnEliminarDoctor">
                                    ...
                                    <!-- eliminar -->
                                    <div>
                                        <button class="btn btn-tabla mb-1 btn-js editar botonesEdi" uk-toggle="target: #modal-examplePacienteEditar23" \="" data-index="23">
                                ...
                                <!-- modal -->
                                <div id="modal-exampleEliminarcita<?= $entrada["id_entrada"]; ?>" uk-modal>
                                    <div class="uk-modal-dialog uk-modal-body tamaño-modal">
                                        ...
                                        <div class="mt-3 uk-text-right">
                                            ...
                                            <a class="btn col-3 btn-agregarcita-modal text-decoration-none"
                                                href="/Sistema-del--CEM--JEHOVA-RAFA/Citas/eliminarCita/<?= $entrada["id_cita"]; ?>/<?= $_SESSION['id_usuario']; ?>">Eliminar</a>
                                        </div>
                                ...
                                <!-- modal -->
                                <div id="modal-examplecitaeditar<?= $entrada["id_entrada"]; ?>" uk-modal class="modalEditar">
                                    <div class="uk-modal-dialog uk-modal-body tamaño-modal" id="modal<?= $entrada["id_entrada"]; ?>">
                                        <!-- Boton que cierra el modal -->
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                                class="bi bi-x-circle uk-modal-close-default azul " viewBox="0 0 16 16">
                                        ...
                                        <form class="form-modal"
                                            action="/Sistema-del--CEM--JEHOVA-RAFA/Citas/editarCita/<?= $entrada["id_cita"]; ?>"
                                            method="POST">
                                            <input type="hidden" value="<?php echo $_SESSION['id_usuario']; ?>" name="id_usuario">

                                            <form class="form-modal"
                                                action="/Sistema-del--CEM--JEHOVA-RAFA/editarCitaHoy/<?= $entrada["id_cita"]; ?>"
                                                method="POST">

                                                <input type="hidden" name="id_cita" value="<?= $entrada["id_cita"]; ?>">
                                                ...
                                                <div class="input-group flex-nowrap caja">
                                                    ...
                                                    <select class="form-control input-modal especialidad" name="consulta">
                                                        <option selected disabled value="<?= $entrada["id_especialidad"] ?>">
                                                    ...
                                                    <ul uk-accordion="multiple: true">
                                                        <li>
                                                            <a class="uk-accordion-title text-decoration-none" href="#">
                                                                ...
                                                                <h6 class="acordion-entrada fw-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                                        fill="currentColor"
                                                ...
                                                <div class="input-group flex-nowrap">
                                                    ...
                                                    <input class="form-control input-modal" type="time" name="hora"
                                                        placeholder="Hora" required value="<?= $entrada["hora"] ?>">
                                                </div>
