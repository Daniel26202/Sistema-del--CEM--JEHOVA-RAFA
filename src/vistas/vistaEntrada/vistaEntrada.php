    ...
    <div class="caja-contenedor-tabla fondo-tabla p-3 mb-3 m-auto table-responsive" style="width: 95%; ">
        ...
        <div class="me-2 ps-3 col-12 caja-boton d-flex justify-content-between align-items-center row ">
            ...
            <?php else: ?>
                ...
                <button class="btn-guardar-responsive  btn btn-primary btn-agregar-doctores col-8" uk-toggle="target: #modal-exampleEntrada" id="registrarEntrada">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <!-- eliminar -->
                                    <div class="me-2">
                                        <button class="btn btn-tabla btnEliminarDoctor mb-1" uk-toggle="target: #modal-exampleEntradaEliminar<?= $entrada["id_entradaDeInsumo"] ?>" id="btnEliminarDoctor">
                                    ...
                                    <!-- eliminar -->
                                    <div>
                                        <button class="btn btnEditarDoctor btn-tabla mb-1 btn-js editar botonesEdi" uk-toggle="target: #modal-exampleEntradaEditar<?= $entrada["id_entradaDeInsumo"] ?>">
