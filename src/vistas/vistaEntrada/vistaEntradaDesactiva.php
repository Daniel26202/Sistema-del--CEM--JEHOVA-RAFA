...
<div class="d-flex">
  ...
  <div class="w-75 ms-5">
    <h3 class="fw-bold" id="inicioServicio">PAPELERA ENTRADAS DE INSUMO
                            ...
                            <div id="eliminarEntrada<?= $e["id_entrada"]; ?>" uk-modal>
                              <div class="uk-modal-dialog uk-modal-body tamaño-modal">
                                ...
                                <div class="mt-5 uk-text-right btn_modal_patologias">
                                  ...
                                  <a href="?c=controladorEntrada/restablecerEntrada&id_entrada=<?= $e["id_entrada"]; ?>&id_usuario_bitacora=<?= $_SESSION['id_usuario'];?>">
