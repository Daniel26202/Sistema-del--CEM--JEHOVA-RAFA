      ...
      <div class="modal-dialog ">
        <div class="modal-content tamaño-modal">
          <div class="modal-header">
            <h5 class="modal-title fs-4 fw-bold" id="labelPaciente">Registrar Paciente</h5>
            ...
            <div class="modal-body">
              ...
              <div class="campo-custom">
                <div class="input-custom">
                  ...
                  <input class="form-control txt-custom input-validar inputs" type="date" name="fn" id="feNacimiento">
                  <span class="icono-der">
                    <svg class="check d-none" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                    </svg>
    ...
    <div class="modal fade" id="info-paciente" tabindex="-1" aria-labelledby="exampleModalLabelMostrar" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content tamaño-modal">
          <div class="modal-header">
