<div id="modal-examplePaciente" uk-modal>
  <div class="uk-modal-dialog uk-modal-body tamaño-modal">
    ...
    <form class="form-modal form-validable form-ajax" submit=false id="modalAgregar" action="/Sistema-del--CEM--JEHOVA-RAFA/Pacientes/guardar" method="POST" autocomplete="off">
