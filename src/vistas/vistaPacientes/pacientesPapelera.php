            ...
            <tr>
              ...
              <td class="text-center">
                ...
                <?php else: ?>
                  ...
                  <div class="me-2">
                    <a href="#" class="btn btn-tabla btn-dt-tabla" uk-toggle="target: #eliminar<?php echo $paciente['id_paciente']; ?>" data-id-tabla="eliminar<?php echo $paciente['id_paciente']; ?>" title="Restablecer Paciente" uk-tooltip id="btnModalEliminarPaciente">
