                    ...
                    <td class="border-start">
                      <div class="d-flex justify-content-center">
                        <div class="me-2 d-flex">
                          <a href="#" uk-toggle="target:#editar<?php echo $paciente['id_paciente']; ?>" title="Modificar Paciente" uk-tooltip id="btnModalEditarPaciente">
                        ...
                        <div class="me-2">
                          <a href="#" uk-toggle="target:#eliminar<?php echo $paciente['id_paciente']; ?>" title="Eliminar Paciente" uk-tooltip id="btnModalEliminarPaciente">
                        ...
                        <div id="eliminar<?= $paciente['id_paciente']; ?>" uk-modal>
                          <div class="uk-modal-dialog uk-modal-body tamaño-modal">
                            ...
                            <div class="mt-3 uk-text-right">
                              ...
                              <a href="?c=ControladorPacientes/eliminar&id_paciente=<?php echo $paciente['id_paciente']; ?>">
