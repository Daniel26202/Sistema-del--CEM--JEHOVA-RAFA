    ...
    <div class="caja-contenedor-tabla fondo-tabla p-3 mb-3 m-auto table-responsive" style="width: 95%; ">
        <div class="me-2 ps-3 col-12 caja-boton d-flex justify-content-between align-items-center row ">
            ...
            <div class="mb-2 mb-md-0 caja-btn-margin w-25">
                ...
                <button class="btnOpenModal caja-btn-margin btn btn-modals" data-bs-toggle="modal" data-bs-target="#exampleModalProveedor" id="btnOpenModalProveedor">
...
<script type="text/javascript" src="<?= $urlBase; ?>../src/assets/js/ayudaInteractiva/ayudaProveedores.js"></script>
