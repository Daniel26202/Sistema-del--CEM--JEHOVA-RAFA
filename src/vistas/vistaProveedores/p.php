    ...
    <div class="d-flex">
        ...
        <div class="w-75 ms-5">
            <h3 class="fw-bold" id="inicioServicio">PROVEEDORES
                ...
                <img src="<?= $urlBase ?>../src/assets/img/proveedor (1).png" width="25" height="25" uk-svg class="mb-2">
            </h3>
                ...
                <li class="li">
                    ...
                    <div class="hover-grande">
                        ...
                        <a href="/Sistema-del--CEM--JEHOVA-RAFA/Proveedores/proveedores" class="text-decoration-none me-3 color-letras" id="DMserviciosExtras">
                            <img src="<?= $urlBase ?>../src/assets/img/proveedor(2).png" width="20" height="20" uk-svg class="me-1">Proveedores</a>
                    </div>
