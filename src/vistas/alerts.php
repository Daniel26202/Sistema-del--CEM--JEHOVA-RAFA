    ...
    <?php if ($parametro != ""): ?>
        ...
        <?php if ($parametro[0] == "errorCedula"): ?>
            <div class="uk-alert-danger comentarioD  comentarioRed me-4 fw-bolder alertaGenerica text-center" uk-alert>
                <a class="uk-alert-close"style="background: black !important;" uk-close></a>
        ...
        <?php elseif ($parametro[0] == "permiso"): ?>
            <div class=" uk-alert-danger comentarioD w-100 fw-bolder alertaGenerica text-center" uk-alert>
                <a class="uk-alert-close"style="background: black !important;" uk-close></a>
                <p class="pe-2">No tiene permiso para hacer dicha acción por favor comuniquese con el adminisrador del sistema</p>
            </div>
