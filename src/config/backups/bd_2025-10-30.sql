...
INSERT INTO `insumodehospitalizacion` VALUES (13,16,58,1),(14,17,52,2),(15,18,60,1),(16,20,54,1),(17,21,64,1),(18,21,52,5),(19,22,52,6),(20,22,61,1),(22,23,58,23),(26,24,60,1),(27,25,60,2),(28,26,53,1),(29,27,60,1),(35,34,65,1);
...
INSERT INTO `servicios_hospitalizacion` VALUES (9,34,25,1);
...
INSERT INTO `sintomas_control` VALUES (37,5,26),(38,10,26),(39,8,26),(40,8,27),(41,9,27),(42,7,27),(43,5,28),(44,6,28),(45,7,28),(46,5,29),(47,6,29),(48,8,29),(49,5,30),(50,6,30),(51,6,31),(52,8,31),(53,6,32),(54,8,32),(55,6,33),(56,8,33),(57,6,34),(58,8,34);
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `devolever_insumos_hospitalizacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `devolever_insumos_hospitalizacion`(
    IN p_id_insumo INT,
    IN p_cantidad INT
)
BEGIN
...
-- Dump completed on 2025-10-30 20:15:53
