    ...
    result.forEach((element) => {
      html += ` <tr>
        ...
        element.id_paciente
                    ...
                    <button class="${
                      urlActual.includes("papelera") ? "d-none" : ""
                    } btn btn-tabla mb-1 btnModalEliminarPaciente btn-dt-tabla btn-eliminar" data-index="${element.cedula}">
        ...
        element.id_cliente
                ...
                <div id="modal-exampleclienteEditar${element.id_cliente}" uk-modal>
                  <div class="uk-modal-dialog uk-modal-body tamaño-modal">
                    ...
                    <form class="form-modal form-validable${element.id_cliente} forms-editar form-ajax" data-index='${
        element.id_cliente
      }' autocomplete="off">
                      <input type="hidden" name="id_usuario" id='id_usuario_bitacora'>
                      <input type="hidden" name="id_cliente" value="${element.id_cliente}">
                      ...
                      <div class="input-group flex-nowrap margin-inputs grpFormCorrect" id="grp_cedula">
                        ...
                        <input class="form-control input-modal input-disabled input-cliente input-validar" style="width: 7vh !important;" type="number" id="cedula" name="cedula" value="${
                          element.cedula
                        }" placeholder="Cedula" required maxlength="8" minlength="6" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                      </div>

                      <p class="p-error-cedula${
                        element.id_cliente
                      } d-none">La cedula debe contener únicamente números y estar entre 6 a 7 caracteres</p>
                      ...
                      <div class="input-group flex-nowrap margin-inputs grpFormCorrect" id="grp_nombre">
                        ...
                        <input class="form-control mayuscula input-modal input-disabled input-cliente input-validar" type="text" id="nombre" name="nombre" value="${
                          element.nombre
                        }" placeholder="Nombre" required maxlength="11">
                      </div>

                      <p class="p-error-nombre${
                        element.id_cliente
                      } d-none">El Nombre debe contener solo letras ademas iniciar con una letra mayúscula y tenga al menos 3 caracteres</p>
                      ...
                      <div class="input-group flex-nowrap margin-inputs grpFormCorrect" id="grp_apellido">
                        ...
                        <input class="form-control input-modal mayuscula input-disabled input-cliente input-validar" type="text" id="apellido" name="apellido" value="${
                          element.apellido
                        }" placeholder="Apellido" required maxlength="11">

                      </div>

                      <p class="p-error-apellido${
                        element.id_cliente
                      } d-none">El Apellido debe contener solo letras ademas iniciar con una letra mayúscula y tenga al menos 3 caracteres</p>
                      ...
                      <div class="input-group flex-nowrap margin-inputs grpFormCorrect" id="grp_telefono">
                        ...
                        <input class="form-control input-modal input-disabled input-cliente input-validar" type="number" id="telefono" name="telefono" placeholder="Telefono" value="${
                          element.telefono
                        }" required maxlength="18">
                      </div>
                      <p class="p-error-telefono${
                        element.id_cliente
                      } d-none">El Telefono solo debe contener y comen números, comenzando con "0412 o 0414 o 0416 o 0424 o 0426 o 0212 o 24"</p>
                      ...
                      <div class="input-group flex-nowrap margin-inputs grpFormCorrect" id="grp_direccion">
                        ...
                        <input class="form-control  mayuscula input-modal input-disabled input-cliente input-validar" type="text" id="direccion" name="direccion" value="${
                          element.direccion
                        }" placeholder="Direccion" required maxlength="20">
                      </div>
                      <p class="p-error-direccion${element.id_cliente} d-none">Debe estar completa y detallada</p>
                      ...
                      <div class="input-group flex-nowrap margin-inputs " id="grp_fn">
                        ...
                        <input class="form-control input-modal input-disabled input-cliente input-validar" type="date"  name="fn" placeholder="Fn" required pattern="\d{4}-\d{2}-\d{2}" value="${
                          element.fn
                        }">
                      </div>
                      <p class="p-error-fn${element.id_cliente} d-none">No puede ser mayor que la fecha actual</p>

                      <label for="" class=" fw-bold mb-1 mt-2">Genero</label>
                      <div class="input-group flex-nowrap margin-inputs grpFormCorrect" id="grp_genero">
                        <span class="input-modal mt-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-calendar2-date-fill azul" viewBox="0 0 16 16">
                            <path d="M9.402 10.246c.625 0 1.184-.484 1.184-1.18 0-.832-.527-1.23-1.16-1.23-.586 0-1.168.387-1.168 1.21 0 .817.543 1.2 1.144 1.2z" />
                            <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zm9.954 3H2.545c-.3 0-.545.224-.545.5v1c0 .276.244.5.545.5h10.91c.3 0 .545-.224.545-.5v-1c0-.276-.244-.5-.546-.5zm-4.118 9.79c1.258 0 2-1.067 2-2.872 0-1.934-.781-2.668-1.953-2.668-.926 0-1.797.672-1.797 1.809 0 1.16.824 1.77 1.676 1.77.746 0 1.23-.376 1.383-.79h.027c-.004 1.316-.461 2.164-1.305 2.164-.664 0-1.008-.45-1.05-.82h-.684c.047.64.594 1.406 1.703 1.406zm-2.89-5.435h-.633A12.6 12.6 0 0 0 4.5 8.16v.695c.375-.257.969-.62 1.258-.777h.012v4.61h.675V7.354z" />
