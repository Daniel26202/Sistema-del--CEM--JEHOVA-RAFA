      ...
      .setOptions({
        steps: [
...

          {
            ...
            intro:
              "ACÁ PODRÁS GESTIONAR LA INFORMACIÓN DE LOS USUARIOS NORMALES",
          },
          {
          ...
          },
          {
            element: document.querySelector(".caja-contenedor-tabla"),
            intro:
              "EN ESTA TABLA SE MUESTRA LA INFORMACIÓN DE TODOS LOS USUARIOS REGISTRADOS",
          },
          {
            element: document.querySelector(".card"),
            intro:
              "EN ESTAS TARJETAS SE PUEDE MUESTRA LAS INFORMACION DE LOS USUARIOS",
          },
          {
          ...
          {
            intro:
              "FIN DEL RECORRIDO POR EL MÓDULO DE USUARIOS, ESPERO HABERTE AYUDADO",
          },
        ],
