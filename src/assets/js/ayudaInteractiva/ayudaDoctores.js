    ...
    .setOptions({
      steps: [
        ...
        },
        {
          ...
          intro:
            "ESTE BOTÓN DESPLIEGA UN MODAL DONDE PODRÁS  REGISTRAR NUEVOS DOCTORES",
        },
        {
          element: document.querySelector("#btnEspecialidades"),
          intro:
            "ESTE BOTÓN TE PERMITE GESTIONAR LAS ESPECIALIDADES DE LOS DOCTORES",
        },
        {
          element: document.querySelector("#DMservicioMedico"),
          intro:
            "ESTE BOTÓN DESPLIEGA UN MODAL DONDE PODRÁS  REGISTRARLE UN SERVICIO MEDICO A UN DOCTOR. ",
        },
        {
          element: document.querySelector("#btnAgregarServicioMedicoPapelera"),
          intro: "ESTE BOTÓN TE REDIRIGE A LA PAPELERA DE DOCTORES. ",
        },
        {
          element: document.querySelector(".dt-search"),
          intro:
            "ESTE BUSCADOR TE PERMITE BUSCAR LOS DOCTORES REGISTRADOS A TRAVÉS DE LA CI",
        },
        {
          element: document.querySelector(".caja-contenedor-tabla"),
        ...
        {
          intro:
            "FIN DEL RECORRIDO POR EL MÓDULO DEL DIRECTORIO MÉDICO, ESPERO HABERTE AYUDADO",
        },
      ],
