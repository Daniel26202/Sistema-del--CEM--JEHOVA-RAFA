            ...
            if (resultad[1] == false) {
                ...
                resultad[1].forEach((res, index) => {
                    ...
                    if (resultad[0][1] == 0) {
                        html += `    
                                            <div class="col-12 col-md-6 col-lg-3">
                                                <a href="/Sistema-del--CEM--JEHOVA-RAFA/Factura/facturarHospitalizacion/${res["id_hospitalizacion"]}" class="btn btn-tabla mb-1 me-1" uk-tooltip="Facturar hospitalización" id="" title=""
