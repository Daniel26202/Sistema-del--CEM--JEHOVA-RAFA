...
const expresiones = {
  ...
  codigo: {
    expresion: /^\d{6,11}$/,
    mensajeError:
      "El código debe contener solo números y tener al menos 6 caracteres",
  },
...
function validarSelect(
  ...
  if (
    ...
    select.value === "" ||
    !expresiones[attExpresion].expresion.test(select.value)
  ) {
...
function validarFormulario(e, formulario, campos) {
  ...
  if (input.tagName === "SELECT") {
    ...
    nameInput === "fn" ||
    nameInput === "fechaDeCita" ||
    nameInput === "fechaDeVencimiento"
  ) {
