document.getElementById('btnayudaCitaRealizadas').addEventListener("click", function() {
    introJs().setOptions({
      steps: [
        {
        ...
        element: document.querySelector('#buscadorCitasP'),
          intro: "CON ESTE BUSCADOR PODRÁS BUSCAR LA CITAS REALIZADAS DE UN PACIENTE A TRAVÉS DE SU CI"
        },
        {  
        element: document.querySelector('#tabla'),
          intro: "AQUÍ SE ENCUENTRAN TODAS LAS CITAS REALIZADAS"
        },
        {  
        ...
        {  
          element: document.querySelector('#citaPendiente'),
            intro: "EN ESTA SECCIÓN ESTAN TODAS LAS CITAS PENDIENTES POR ATENDER"
          },
        {  
