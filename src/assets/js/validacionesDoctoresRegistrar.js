document.addEventListener("DOMContentLoaded", function () {
  ...
  function validarFormulario(e) {
    ...
    switch (e.target.name) {
      ...
      case "dias[]":
        ...
        let seleccionadoD = Array.from(inputCheD).some(
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (campos.cedula && campos.nombre && campos.horas && campos.dia && campos.apellido && campos.telefono && campos.usuario && campos.password && campos.email) {
      form.submit();
    } else {
      e.preventDefault();
