        ...
        .setOptions({
          steps: [
            ...
            },
            {
              ...
              intro:
                "AL OPRIMIR ESTE BOTÓN SE VA A DESPLEGAR UN MODAL CON UN FORMULARIO PARA REGISTRAR LA INFORMACIÓN DE LOS NUEVOS PACIENTES",
            },
            {
              element: document.querySelector(".dt-search"),
              intro:
                "AQUÍ TIENES UN BUSCADOR QUE AL COLOCAR LA CI DEL PACIENTE VA A DESPLEGAR UN MODAL CON LOS RESULTADOS",
            },
            {
              element: document.querySelector(".caja-contenedor-tabla"),
              intro:
                "EN ESTA TABLA SE MUESTRA LA INFORMACIÓN DE TODOS LOS PACIENTES REGISTRADOS",
            },
            {
              element: document.querySelector(".btnModalEditarPaciente"),
              intro:
                "AL PULSAR ESTE BOTON SE VA A DESPLEGAR UN MODAL PARA MODIFICAR LA INFORMACIÓN DEL PACIENTE",
            },
            {
              element: document.querySelector(".btnModalEliminarPaciente"),
              intro:
                "AL PULSAR ESTE BOTON SE VA A DESPLEGAR UN MODAL PARA ELIMINAR LA INFORMACIÓN DEL PACIENTE",
            },
            {
            ...
            {
              intro:
                "FIN DEL RECORRIDO POR EL MÓDULO DE PACIENTES, ESPERO HABERTE AYUDADO",
            },
          ],
