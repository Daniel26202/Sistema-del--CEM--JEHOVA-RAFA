addEventListener("DOMContentLoaded", function () {
              ...
              <tr>
                              ...
                              <td>
                                  <button class="btn col-3 btn-agregarcita-modal editar btnEditar buttomEditControl" type="button"
                                      ...
                                      data-id-Patient="${element.id_Patient}" ${disabled}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    const saveControl = async () => {
        ...
        try {
            ...
            textAlert = `Se registró correctamente el control médico`;
            classAlert = "uk-alert-primary";
    ...
    const editControl = async () => {
        ...
        try {
            ...
            if (result.success == "exito") {
                ...
                textAlert = `Se modifico correctamente el control medico del Paciente`;
                classAlert = "uk-alert-primary";
            } else {
                textAlert = `Lamentablemente algo salio mal por favor intente mas tarde`;
                classAlert = "uk-alert-danger";
