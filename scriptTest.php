...
/*
    ...
    🔎
*/
define("LIST_TESTS", ["login", "pacientes","citas","facturacion"]);
...
if($__executeTest("pacientes")) (new PacientesSelenium($apicontroller))->testPacientes();
if($__executeTest("citas")) (new CitasSelenium($apicontroller))->testCitas();
if($__executeTest("facturacion")) (new FacturacionSelenium($apicontroller))->testfacturacion();
